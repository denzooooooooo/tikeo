...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {/* Sidebar */}
      <aside className={`
        fixed lg:static inset-y-0 left-0 z-50 w-[85vw] max-w-72 lg:w-64 bg-gradient-to-b from-gray-900 to-gray-800 
      ...
      `}>
        <div className="flex flex-col h-full">
              ...
              return (
                <Link
                  ...
                  className={`
                    ...
                    ${isActive 
                      ? 'bg-[#5B7CFF] text-white shadow-lg shadow-[#5B7CFF]/25' 
          ...
          <div className="p-4 border-t border-gray-700">
            <Link
              href="/dashboard"
              className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:bg-gray-700/50 hover:text-white transition-all mb-2"
            >
              <HomeIcon />
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        {/* Mobile header */}
        <header className="lg:hidden bg-white border-b border-gray-200 px-3 py-2.5 flex items-center justify-between sticky top-0 z-30">
          <button

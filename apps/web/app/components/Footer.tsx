        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-[#5B7CFF] to-[#7B61FF] rounded-xl flex items-center justify-center">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 bg-gray-800 hover:bg-[#5B7CFF] rounded-lg flex items-center justify-center transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/events?category=Spectacles" className="hover:text-white transition-colors">
                  Spectacles
                </Link>
              </li>
              <li>

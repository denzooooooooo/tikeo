...
const CATEGORIES = [
  ...
  { name: 'Famille', image: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=600&q=80', color: 'from-teal-500 to-cyan-600' },
];

interface HomeCategorieSectionProps {
...
export default function HomeCategoriesSection({ categoryCounts = {} }: HomeCategorieSectionProps) {
  return (
              ...
              >
                ...
                <div className="relative z-10 p-5 h-full flex flex-col justify-between">
                  <div>
                    ...
                    {countLabel && (
                      <p className="text-sm text-white/85 drop-shadow-md">{countLabel} événements</p>
                    )}
                  </div>

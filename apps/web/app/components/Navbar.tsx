    ...
    <>
      <nav className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#f3f4f6] border-b border-gray-200' : 'bg-[#f3f4f6] border-b border-gray-200'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[72px] lg:h-[76px] gap-3">

            {/* Logo */}
            <Link href="/" className="flex items-center gap-2.5 flex-shrink-0">
              <div className="w-14 h-14 lg:w-20 lg:h-20 overflow-hidden flex items-center justify-center bg-[#f3f4f6] rounded-lg">
                <Image src="/PHOTO-2026-03-12-22-03-13-removebg-preview.png" alt="Tikeoh Logo" width={70} height={70} className="w-full h-full object-contain" />
              </div>
            </Link>
